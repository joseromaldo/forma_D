                        ...
                        <tr>
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="/controlAlumnos/vistas/armas/modificar.php?arma_id=<?= base64_encode($arma['arma_id'])?>"><i class="bi bi-pencil-square me-2"></i>Modificar</a></li>
                                    <li><a class="dropdown-item" href="/controlAlumnos/controladores/armas/eliminar.php?arma_id=<?= base64_encode($arma['arma_id'])?>"><i class="bi bi-trash me-2"></i>Eliminar</a></li>
                                </ul>
                            </div>
